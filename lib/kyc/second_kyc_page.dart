...
import 'drivers_kyc_page.dart';


class SecondKycPage extends StatefulWidget {
  const SecondKycPage({Key? key}) : super(key: key);

  @override
  SecondKycPageState createState() => SecondKycPageState();
}

class SecondKycPageState extends State<SecondKycPage> {
            ...
            child: const Row(
              children: [
                ...
                Expanded(
                  child: Center(
                    child: Text(
                      'Capture back image of driver\'s license.',
                      style: TextStyle(
                        fontFamily: 'Quicksand',
                        fontSize: 14,
                        fontWeight: FontWeight.w500,
            ...
            child: ElevatedButton(
              onPressed: () {
                Navigator.push(
                   context,
                   MaterialPageRoute(
                    builder: (context) => const DriverKycPage()),
                 );
              },
