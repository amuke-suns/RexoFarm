                  ...
                  Positioned(
                    ...
                    Positioned(
                      ...
                      child: OutlinedButton.icon(
                        onPressed: () {},
                        icon: const Icon(Icons.south_west, size: 18), // Arrow icon facing down
          ...
          SizedBox(
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  // frame213i4m (97:522)
                  margin: const EdgeInsets.fromLTRB(0, 0, 132, 0),
          ...
          Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Container(
                                      // frame213h57 (97:515)
                                      margin: const EdgeInsets.fromLTRB(0, 0, 143, 0),
                                      height: double.infinity,
                                      child: Column(
                                        crossAxisAlignment: CrossAxisAlignment.start,
                                        children: [
        ...
        Container(
          ...
          child: Row(
            ...
            children: [
              Container(
                // frame213NDB (97:532)
                margin: const EdgeInsets.fromLTRB(0, 0, 137, 0),
                height: double.infinity,
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
        ...
        Container(
          ...
          child: Row(
            ...
            children: [
              Container(
                // frame213nAR (97:537)
                margin: const EdgeInsets.fromLTRB(0, 0, 171, 0),
                height: double.infinity,
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
